...
useWhen:
  ...
  - Following file naming convention ${technology}-${specialization}.md in resources/agents/_fragments/ directory with metadata including 5-8 tags, 3-4 capabilities, 3-4 useWhen scenarios
estimatedTokens: 580
---
...
Location: resources/agents/_fragments/
