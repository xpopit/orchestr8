...
4. Create file: resources/agents/_fragments/${id}.md
```
...
4. Create file: resources/skills/_fragments/${id}.md
```
...
4. Create file: resources/patterns/_fragments/${id}.md
```
...
4. Create file: resources/examples/_fragments/${id}.md
```
...
```bash
# Save new fragment
mv ${fragment}.md resources/${category}/_fragments/
...
- Agent: ${id}
  - Location: resources/agents/_fragments/${id}.md
  - Captures: ${what-knowledge}
  - Findable via: ${sample-queries}

- Skill: ${id}
  - Location: resources/skills/_fragments/${id}.md
...
## Integration:
Saved to resources/{category}/_fragments/ ✅
