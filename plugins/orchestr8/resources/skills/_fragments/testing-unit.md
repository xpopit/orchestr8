...
capabilities:
  ...
  - Mocking dependencies and test doubles (mocks, stubs, spies)
  - Test assertions and matchers
  - Test isolation and setup techniques
  - Test organization and structure
  - Dependency injection for testability
estimatedTokens: 780
useWhen:
  - Writing unit tests for TypeScript business logic with Jest covering edge cases and error paths
  - Building test suites with AAA pattern (Arrange, Act, Assert) for readable and maintainable tests
  - Creating unit test strategy with test doubles (mocks, stubs, spies) isolating dependencies
  - Implementing TDD workflow writing failing tests first then minimum code to pass
  - Designing test coverage strategy targeting critical business logic with 80%+ branch coverage
  - Implementing unit testing best practices with test isolation, fast execution, and deterministic results
  - Building test pyramid strategy emphasizing unit tests over integration and e2e tests for faster feedback
  - Creating unit test naming convention describing what is tested, under what conditions, and expected outcome
  - Designing test doubles strategy using mocks for external dependencies and spies for behavior verification
  - Implementing parameterized tests with test.each for validating multiple input scenarios efficiently
---
